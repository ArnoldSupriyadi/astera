...
ul.product_details_ul_1 {
    margin-top: 18px;
    display: flex;
}

li.product_details_li_1 {
    font-size: 18px;
    color: black;
    margin-right: 10px;
}

.product_details_div_11 {
    background-color: #e1e1e1;
    padding: 30px 0px;
    margin-top: 30px;
}

img.product_details_img_3 {
    width: 260px;
    height: 260px;
    border-radius: 50%;
}
...
<div class="page-wrapper">
            ...
            <div class="main-box clearfix">
                <div class="logo-box">
                    ...
                    <div class="logo"><a href="index.php">
                        ...
                        <img src="images/logo.jpg" alt="" style="width: 100%; height: 54px!important;" title="">
                        <!-- <h2>LOGO</h2> -->
            ...
            <div class="auto-container clearfix">
                ...
                <div class="logo pull-left">
                    <a href="index.php" title="">
                        <img src="images/logo.jpg" alt="" style="width: 100%; height: 50px;" title="">
                    </a>
                </div>
                <!--Right Col-->
    ...
    <section class="banner-section">
        <div class="banner-carousel owl-carousel owl-theme">
            <div class="slide-item" style="background-image: url(image/bluegold.jpeg);">
                <div class="auto-container">
                    <div class="content-box">
                        <h2 >Astera Room</h2>
                        <div class="text ">Update from Astera Editors</div>
...
-->
            ...
            <div class="slide-item" style="background-image: url(image/valcuchristmasquartztree.jpg);">
                <div class="auto-container">
                    <div class="content-box">
                        <h2 class="">Editor Choice</h2>
                        <div class="text ">The buildings speak for themselves</div>
                        <p class="product_banner_p_1 ">
                            <span class="product_banner_span_1">
                                <a href="index.php">Home</a>
    ...
    <!-- artcal body -->
        ...
        <section>
            <div class="artcal_div_1">
                <img src="image/slider/sliderbsd5.jpg" class="artcal_img_1">
                <p class="artcal_p_1">
                ...
                <div class="artcal_div_2">
                    <div class="row">
                        <div class="col-lg-5 col-md-5 col-12" style="padding: 0px;">
                            <div class="artcal_div_3">
                                <img src="image/piatra2.jpg" class="artcal_img_1">
                            </div>
                        </div>
                ...
                <div class="product_details_div_10">
                    <ul class="product_details_ul_1">
                        <li class="product_details_li_1">
                    ...
                    <div class="product_details_div_11">
                        <div class="row">
                            <div class="col-lg-4 col-md-4 col-12">
                                <div class="product_details_div_12">
                                    <img src="image/5112_aterra-blanca_d.jpeg" class="product_details_img_3">
                                </div>
                            </div>
                ...
                <div class="product_details_div_7">
                    <p class="artcal_p_6">
                        Related post
                    </p>
                    <div id="demo10" class="carousel slide" data-ride="carousel">
                        ...
                        <ul class="carousel-indicators">
                            <li data-target="#demo10" data-slide-to="0" class="active" style="background-color: #851414;"></li>
                            <li data-target="#demo10" data-slide-to="1" style="background-color: #851414;"></li>
                            <li data-target="#demo10" data-slide-to="2" style="background-color: #851414;"></li>
                        </ul>

                        <div class="carousel-inner">
                            <div class="carousel-item active">
                                <div class="product_details_div_8">
                                    <div class="row">
                                        <div class="col-lg-4 col-md-4 col-6">
                                            <div class="product_details_div_9">
                                                <img src="images/main-slider/image-1.jpg" class="product_details_img_2">
                                                <p class="product_details_p_1">
                                                    Lorem Ipsum is simply dummy
                                                </p>
                                                <p class="product_details_p_2">
                                                    Lorem Ipsum is simply dummy text of the printing 
                                                </p>
                                                <p class="product_details_p_3">
    					...
    					<div class="row">
    						...
    						<div class="footer-column col-xl-6 col-lg-6 col-md-6 col-sm-12">
    							<div class="footer-widget about-widget">
    								<div class="footer-logo">
    									<figure>
    										<a href="index.php">
    											<img src="images/logo.jpg" style="width: 51%; height: 50px;" alt="">
    											<!-- <h2 style="font-size: 36px;">LOGO</h2> -->
    										</a>
    									</figure>
    								</div>
    								<div class="widget-content">
    									<div class="text">Lorem Ipsum dolor sit amet,consectetur adipisicing elit, sed doeiusmod tempor incididunt ut laboreet dolore magna aliqua. Ut enim adminim veniam, quis nostrudexercitation ullamco laboris nisi utaliquip ex ea commodo consequat.</div>
    								</div>
    							</div>
    						</div>
    						...
    						<div class="footer-column col-xl-6 col-lg-6 col-md-6 col-sm-12">
    							<div class="footer-widget recent-posts">
    								...
    								<div class="widget-content">
    									<div class="post">
    										<div class="thumb"><a href="javascript:void(0);"><img src="images/resource/post-thumb-1.jpg" alt=""></a></div>
    										<h4><a href="javascript:void(0);">Triangle Concrete House on lake</a></h4>
    										<ul class="info">
    											<li>8 May</li>
    											<li>3 Comments</li>
    										</ul>
    									...
    									<div class="post">
    										<div class="thumb"><a href="javascript:void(0);"><img src="images/resource/post-thumb-2.jpg" alt=""></a></div>
    										<h4><a href="javascript:void(0);">The Amazing Interior for the Hotel art</a></h4>
    										<ul class="info">
    											<li>8 May</li>
    											<li>3 Comments</li>
    										</ul>
    		...
    		<div class="auto-container">
    			<div class="inner-container clearfix">
    				...
    				<div class="copyright-text">
    					<p> Copyright All rights reserved | Design & Developed <i class="fa fa-heart" aria-hidden="true" style="color: red;"></i><!--  by <a href="https://www.iwebnext.com/" target="_blank">Iwebnext</a> --></p>
    				</div>
    			</div>
    		</div>
    	</div>
