...
if(isset($_POST['submit'])){
   ...
   // $buy_a_home = $_POST['editor3'];
    ...
    $content= $_POST['editor5'];
    $sql = mysqli_query($con, "UPDATE  what_we_do_content SET content='$content' WHERE id=1 ");
                    ...
                    <div class="panel panel-bd lobidrag">
                        ...
                        <div class="panel-body">
                            ...
                            <form class="col-md-12" action="" method="post" enctype="multipart/form-data">
                                ...
                                <?php
                                $sqlqry= mysqli_query($con,"select * from  what_we_do_content where id=1 ");
                                $tot=mysqli_fetch_assoc($sqlqry);
                                ?>
                                <!-- <div class="col-md-12">
                                    <div class="col-md-12">
                                ...
                                <div class="col-md-12">
                                    <div class="col-md-12">
                                        <div class="form-group col-sm-12">
                                            ...
                                            <textarea name="editor5" ><?php echo $tot['content'] ?></textarea>
                                        </div>
                                    </div>
                                </div>
