    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            ...
            <div class="header-title">
                ...
                <small>Contact Details List</small>
            </div>
        </section>
        <!-- Main content -->
                            ...
                            <div class="table-responsive">
                                <table id="dataTableExample1" class="table table-bordered table-striped table-hover">
                                    ...
                                    <tr class="info">
                                        ...
                                        <th style="width:20%;text-align: center"> Customer Company</th>

                                        <th style="width:20%;text-align: center"> Customer Email</th>

                                        <th style="width:5%;text-align: center"> Customer Phone</th>
                                    ...
                                    while($total=mysqli_fetch_assoc($sql))
                                    {
                                        ...
                                        <tr>
                                            ...
                                            <td style="text-align: center"><?php echo $total['company'];?></td>
