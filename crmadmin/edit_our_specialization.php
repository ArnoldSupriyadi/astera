...
if(isset($_POST['submit'])){
    ...
    if($file_name=='')
    {
        ...
        unlink("../our_specialization/".$_POST['img_id']);
    }
    ...
    if(empty($errors)==true) {
        ...
        move_uploaded_file($file_tmp, "../our_specialization/" . $file_name);
    ...
    $sql = mysqli_query($con, "UPDATE  our_specialization SET link='$link' ,content='$content', image='$file_name'   WHERE id=$pid ");
            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="panel panel-bd lobidrag">
                        ...
                        <?php
                            $crid=$_GET['crtid'];
                            $sql= mysqli_query($con,"select * from our_specialization where id='$crid'  ");
...
<div class="col-md-12">
    ...
    <div class="row"  style="padding-left: 25px;"  >
        <div  class="form-group col-sm-6">
            <div><label> Choose Blog Image </label>
                <img src="../our_specialization/<?php echo $total['image'];?>"  style="width: 150px;height: 120px; margin-bottom: 20px">
    ...
    <div class="col-md-12">
        <div class="form-group col-sm-12">
            ...
            <textarea type="text" name="editor" style="width: 515px;height: 160px;"><?php echo $total['content'];?></textarea>
        </div>
    </div>
...
<div class="col-md-12">
    <div class="reset-button" style="padding-left: 390px;">
        <input type="submit" name="submit" value="Update Our Specialization" class="btn btn-add">
    </div>
</div>
