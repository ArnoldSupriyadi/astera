...
if(isset($_POST['submit'])){
    ...
    $file_name = $_FILES['image']['name'];
     ...
     if($file_name=='')
     {
         $file_name = $_POST['image1'];
          ...
          unlink("../thumbimage1/".$_POST['img_id']);
      }
     ...
     if(empty($errors)==true) {
         ...
         move_uploaded_file($file_tmp, "../thumbimage1/" . $file_name);
     ...
     if($file_name1=='')
     {
         $file_name1 = $_POST['image2'];
          ...
          unlink("../thumbimage1/".$_POST['img_idd']);
      }
     ...
     if(empty($errors)==true) {
         ...
         move_uploaded_file($file_tmp, "../thumbimage1/" . $file_name1);
     ...
     if($file_name2=='')
     {
         $file_name2 = $_POST['image3'];
          ...
          unlink("../thumbimage1/".$_POST['img_idt']);
      }
     ...
     if(empty($errors)==true) {
         ...
         move_uploaded_file($file_tmp, "../thumbimage1/" . $file_name2);
    ...
    $sql = mysqli_query($con, "UPDATE   home_video_1 SET video1='$video1',video2='$video2',video3='$video3',image='$file_name',image1='$file_name1',image2='$file_name2' WHERE id=1 ");
                    ...
                    <div class="panel panel-bd lobidrag">
                        ...
                        <div class="panel-body">
                            <form class="col-md-12" action="" method="post" enctype="multipart/form-data">
                                <?php
                                $sqlqry= mysqli_query($con,"select * from  home_video_1 where id=1 ");
                                ...
                                <p>Ex:Like This is the YouTube Url-https://www.youtube.com/watch?v=<mark><b>LTXD6XZXc3U</b></mark>And you can put only the <b>highlighted</b> part</p>
                                 ...
                                 <label> Enter First Video Url : </label><br>
                                   <input type="text" class="form-control" placeholder="" value="<?php echo $total['video1'];?>"  name="video1" style="width: 426px;" >
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group col-sm-12">
                                                <label> Enter Second video Url : </label><br>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group col-sm-12">
                                                <label> Enter Third video Url : </label><br>
