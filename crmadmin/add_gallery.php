...
if(isset($_POST['submit'])){
    ...
    if(empty($errors)==true) {
        ...
        move_uploaded_file($file_tmp, "../galleryimage/" . $file_name);
    ...
    $sql = mysqli_query($con, "INSERT INTO gallery (image)VALUES('$file_name')");
    ...
    if($sql){
        ...
        $msg1="Gallery Not Inserted... Plese Try Again";
    }
                    ...
                    <div class="panel panel-bd lobidrag">
                        ...
                        <div class="panel-body">
                            ...
                            <form class="col-md-12" action="" method="post" enctype="multipart/form-data">
                                ...
                                <div class="col-md-12">
                                    ...
                                    <div class="col-md-6">
                                        <div  class="form-group col-sm-6">
                                            <label> Choose Gallery Image :</label>
                        ...
                        <div class="col-md-12">
                            <div class="reset-button" style="padding-left: 390px;">
                                <input type="submit" name="submit" value="Add New Gallery" class="btn btn-add">
                            </div>
                        </div>
