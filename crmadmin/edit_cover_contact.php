...
if(isset($_POST['submit'])){
    ...
    $sql = mysqli_query($con, "UPDATE contact_banner_image SET banner_image='$file_name'  WHERE id=$pid ");
            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="panel panel-bd lobidrag">
                        ...
                        <?php
                            $crid=$_GET['crtid'];
                            $sql= mysqli_query($con,"select * from contact_banner_image where id='$crid'  ");
...
<div class="col-md-12">
    ...
    <div class="row"  style="padding-left: 25px;">
        <div  class="form-group col-sm-6">
            <div><label> Choose Cover Contact </label>
...
<div class="col-md-12">
    <div class="reset-button" style="padding-left: 390px;">
        <input type="submit" name="submit" value="Update Cover Contact" class="btn btn-add">
    </div>
</div>
