...
if(isset($_POST['submit'])){
    ...
    $sql = mysqli_query($con, "UPDATE sslider SET name='$name', price='$price', sale_price='$sale_price' ,image='$file_name' ,banner_image='$file_name_banner', image_detail1='$file_name1', image_detail2='$file_name2', image_detail3='$file_name3', image_detail4='$file_name4', image_detail5='$file_name5'  WHERE id=$pid ");
    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            ...
            <div class="header-title">
                <h1>Edit Second Product Details</h1>
            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="panel panel-bd lobidrag">
                        ...
                        <?php
                            $crid=$_GET['crtid'];
                            $sql= mysqli_query($con,"select * from sslider where id='$crid'  ");
