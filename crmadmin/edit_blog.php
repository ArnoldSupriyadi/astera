...
if(isset($_POST['submit'])){
    ...
    $sql = mysqli_query($con, "UPDATE   blog SET name='$name' ,content='$content', image='$file_name'   WHERE id=$pid ");
            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="panel panel-bd lobidrag">
                        ...
                        <?php
                            $crid=$_GET['crtid'];
                            $sql= mysqli_query($con,"select * from blog where id='$crid'  ");
    ...
    <div class="row"  style="padding-left: 25px;"  >
        <div  class="form-group col-sm-6">
            <div><label> Choose Blog Image </label>
                <img src="../blogimage/<?php echo $total['image'];?>"  style="width: 150px;height: 120px;">
...
<div class="col-md-12">
    <div class="reset-button" style="padding-left: 390px;">
        <input type="submit" name="submit" value="Update Blog" class="btn btn-add">
    </div>
</div>
