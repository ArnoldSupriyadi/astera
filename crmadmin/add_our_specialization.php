                                    ...
                                    <?php
                                     ...
                                     ?>
                                        ...
                                        <tr>
                                            ...
                                            <td style="text-align: center"><img src="../our_specialization/<?php echo $total['image'];?>"  style="width: 200px;height: 200px;"> </td>


                                            <td style="text-align: center"><?php echo $total['content'];?></td>

                                            <td style="text-align: center"><a href="<?= basename($total['link']) ;?>"><?php echo ($total['link']);?></td>


                                            <td>
                                                <a href="edit_our_specialization.php?crtid=<?php echo $total['id'];?>"><button type="button" class="btn btn-add btn-sm" style="width: 50px;height: 25px; color: whitesmoke;background-color: #00bdfd; border-color:#00bdfd "><i class="fa fa-pencil"></i>Edit</button></a>
                                                <div>&nbsp;</div>
