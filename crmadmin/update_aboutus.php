...
if(isset($_POST['submit'])){
   ...
   // $buy_a_home = $_POST['editor3'];
    ...
    if(empty($errors)==true) {
        ...
        move_uploaded_file($file_tmp, "../imageabout/" . $file_name);



    }

    $sql = mysqli_query($con, "UPDATE  about SET image='$file_name',title='$title',content='$content' WHERE id=1 ");
                                ...
                                <!-- <div class="col-md-12">
                                 ...
                                 <div class="col-md-12">
                                        <div  class="form-group col-sm-12">
                                            ...
                                            <img src="../imageabout/<?php echo $tota['image'];?>"  style="width: 250px;height: 250px;">
