                                     ...
                                     ?>
                                        <tr>
                                         ...
                                         <!--    <td style="text-align: center"><?php echo $total['title'];?></td>
                                            ...
                                            <td>
                                                <a href="edit_thirdproduct.php?crtid=<?php echo $total['id'];?>"><button type="button" class="btn btn-add btn-sm" style="width: 50px;height: 25px; color: whitesmoke;background-color: #00bdfd; border-color:#00bdfd "><i class="fa fa-pencil"></i>Edit</button></a>
                                                <div>&nbsp;</div>
                                                <a href="delete_thirdproduct.php?crtid=<?php echo $total['id'];?>&img_id=<?php echo $total['image'];?>"><button type="button" class="btn btn-delete btn-sm" style="width: 50px;height: 25px; color: whitesmoke;background-color: red; border-color:red"><i class="fa fa-trash-o"></i>Delete</button></a>
                                            </td>
