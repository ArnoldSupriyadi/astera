    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            ...
            <div class="header-title">
                <h1>Show Appointment Details</h1>
                <small>Appointment Details List</small>
            </div>
        </section>
        <!-- Main content -->
                    ...
                    <div class="panel panel-bd lobidrag">
                        <div class="panel-heading">
                            <div class="btn-group" id="buttonexport">
                                <a href="#">
                                    <h4>Show Appointment Details</h4>
                                </a>
                            </div>
                        </div>
                            ...
                            <div class="table-responsive">
                                <table id="dataTableExample1" class="table table-bordered table-striped table-hover">
                                    ...
                                    <tr class="info">
                                        ...
                                        <th style="width:10%;text-align: center"> Customer First Name</th>

                                        <th style="width:10%;text-align: center"> Customer Last Name</th>

                                        <th style="width:10%;text-align: center"> Customer Email</th>

                                        <th style="width:10%;text-align: center"> Customer Phone</th>
                                    ...
                                    while($total=mysqli_fetch_assoc($sql))
                                    {
                                        ...
                                        ?>
                                        <tr>
                                            <td style="text-align: center"><?php echo $total['date'];?></td>

                                             <td style="text-align: center"><?php echo $total['time'];?></td>
                                            
                                            <td style="text-align: center"><?php echo $total['fname'];?></td>

                                            <td style="text-align: center"><?php echo $total['lname'];?></td>
                                            
                                            <!-- <?php
                                              if($total['image']!=''){
                                            ?>
                                            <td style="text-align: center"><img src="../bannerimage/<?php echo $total['image'];?>" style="width: 150px;height:120px;"></td>
                                            <?php } else { ?>
                                            <td style="text-align: center"><img  style="width: 150px;height:120px;"></td>
                                            <?php } ?> -->

                                            <td style="text-align: center"><?php echo $total['email'];?></td>

                                            <td style="text-align: center"><?php echo $total['phone'];?></td>

                                            
                                               
                                               <td style="text-align: center"><?php echo $total['message'];?></td>
                                           <!--  <td>
