...
if(isset($_POST['submit'])){
    ...
    if($file_name=='')
    {
        ...
        unlink("../virtual_class_image/".$_POST['img_id']);
    }
    ...
    if(empty($errors)==true) {
        ...
        move_uploaded_file($file_tmp, "../virtual_class_image/" . $file_name);
    ...
    $sql = mysqli_query($con, "UPDATE   virtual_class SET class_name='$class_name', class_url='$class_url', class_content='$class_content', class_image='$file_name'   WHERE id=$pid ");

    if($sql){
        $msg="Virtual Class Updated Successfully...";
    }
    else{
        $msg1="Virtual Class Does not Updated...Try Again.";
    }
}
    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            ...
            <div class="header-title">
                <h1>Edit Virtual Class Details</h1>
                    ...
                    <div class="panel panel-bd lobidrag">
                        ...
                        <div class="panel-body">
                            <form class="col-md-12" action="" method="post" enctype="multipart/form-data">
                                <?php
                                $crid=$_GET['crtid'];
                                $sql= mysqli_query($con,"select * from virtual_class where id='$crid'  ");
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <div  class="form-group col-sm-12">
                                                ...
                                                <img src="../virtual_class_image/<?php echo $total['class_image'];?>"  style="width: 200px;height: 150px;">
                                ...
                                <div class="col-md-12">
                                    <div class="reset-button" style="padding-left: 390px;">
                                        ...
                                        <input type="submit" name="submit" value="Update Virtual Class" style="width: 200px;" class="btn btn-add">
                                    </div>
                                </div>
