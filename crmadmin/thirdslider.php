...
if(isset($_POST['submit'])){
    ...
    $sql = mysqli_query($con, "INSERT INTO tslider (name, price, sale_price, image, banner_image, image_detail1, image_detail2, image_detail3, image_detail4, image_detail5)VALUES('$name','$price','$sale_price','$file_name','$file_name_banner','$file_name1','$file_name2','$file_name3','$file_name4','$file_name5')");
