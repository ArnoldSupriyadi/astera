            ...
            <div class="row">
                            ...
                            <div class="table-responsive">
                                <table id="dataTableExample1" class="table table-bordered table-striped table-hover">
                                    ...
                                    <tr class="info">
                                        ...
                                        <th style="width:10%;text-align: center">Music Video</th>
                                    ...
                                    <tbody>
                                    <?php
                                    $sql= mysqli_query($con,"select * from  music_video ");
              ...
              <iframe style="width: 100%;height: 260px" src="https://www.youtube.com/embed/<?php echo $total['url'];?>" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe> 
                                            ...
                                            <td>
                                                ...
                                                <div>&nbsp;</div>
                                                <a href="delete_musicvideo.php?crtid=<?php echo $total['id'];?>&img_id=<?php echo $total['url'];?>"><button type="button" class="btn btn-delete btn-sm" style="width: 50px;height: 25px; color: whitesmoke;background-color: red; border-color:red"><i class="fa fa-trash-o"></i>Delete</button></a>
                                            </td>
