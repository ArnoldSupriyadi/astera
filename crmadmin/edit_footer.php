    ...
    <div class="row"  style="padding-left: 25px;"  >
        <div  class="form-group col-sm-6">
            <div><label> Choose Image </label>
                <img src="../footer/<?php echo $total['image'];?>"  style="width: 150px;height: 120px; margin-bottom: 20px">
    ...
    <div class="row">
        <div class="col-md-12" style="padding-left: 25px">
            <div class="form-group col-sm-6">
                ...
                <input type="text" class="form-control" value="<?php echo $total['content'];?>" placeholder=""  name="content" style="width: 920px;" >
            </div>
        </div>
    </div>
