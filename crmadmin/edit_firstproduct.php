...
if(isset($_POST['submit'])){
    ...
    $sql = mysqli_query($con, "UPDATE fslider SET name='$name', price='$price', sale_price='$sale_price' ,image='$file_name' ,banner_image='$file_name_banner', image_detail1='$file_name1', image_detail2='$file_name2', image_detail3='$file_name3', image_detail4='$file_name4', image_detail5='$file_name5'  WHERE id=$pid ");
    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            ...
            <div class="header-title">
                <h1>Edit First Product Details</h1>
            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="panel panel-bd lobidrag">
                        ...
                        <?php
                            $crid=$_GET['crtid'];
                            $sql= mysqli_query($con,"select * from fslider where id='$crid'  ");
...
<div class="col-md-12">
    ...
    <input type="hidden" name="banner_image1" value="<?php echo $total['banner_image'];?>">

    <input type="hidden" name="img_id_banner" value="<?php echo $total['banner_image'];?>">

    <input type="hidden" name="image_detail_post1" value="<?php echo $total['image_detail1'];?>">

    <input type="hidden" name="img_id_detail1" value="<?php echo $total['image_detail1'];?>">

    <input type="hidden" name="image_detail_post2" value="<?php echo $total['image_detail2'];?>">

    <input type="hidden" name="img_id_detail2" value="<?php echo $total['image_detail2'];?>">

    <input type="hidden" name="image_detail_post3" value="<?php echo $total['image_detail3'];?>">

    <input type="hidden" name="img_id_detail3" value="<?php echo $total['image_detail3'];?>">

    <input type="hidden" name="image_detail_post4" value="<?php echo $total['image_detail4'];?>">

    <input type="hidden" name="img_id_detail4" value="<?php echo $total['image_detail4'];?>">

    <input type="hidden" name="image_detail_post4" value="<?php echo $total['image_detail5'];?>">

    <input type="hidden" name="img_id_detail4" value="<?php echo $total['image_detail5'];?>">
