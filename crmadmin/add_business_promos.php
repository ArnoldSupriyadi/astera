...
$sql = mysqli_query($con, "INSERT INTO business_promos_video (url)VALUES('$url')");


    if($sql){
        $msg=" Business Promos Video Inserted successfully ";
    }
    else{
        $msg1="Business Promos Video Not Inserted... Plese Try Again";
    }
    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            ...
            <div class="header-title">
                <h1> Add Business Promos Video</h1>
                    ...
                    <div class="panel panel-bd lobidrag">
                        <div class="panel-heading">
                            <div class="btn-group" id="buttonexport">
                                <h4>Add Business Promos Video</h4>
...
<p>Ex:Like This is the YouTube Url-https://www.youtube.com/watch?v=<mark><b>LTXD6XZXc3U</b></mark>And you can put only the <b>highlighted</b> part</p>
                        ...
                        <div class="col-md-12">
                            <div class="reset-button" style="padding-left: 390px;">
                                <input type="submit" name="submit" value="Add New Business Promos Video" class="btn btn-add">
                            </div>
                        </div>
