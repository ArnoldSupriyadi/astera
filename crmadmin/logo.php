...
if(isset($_POST['submit'])){
   ...
   // $buy_a_home = $_POST['editor3'];
    ...
    $sql = mysqli_query($con, "UPDATE  logo SET image='$file_name' WHERE id=1 ");
    ...
    if($sql){
        ...
        $msg1="Logo Content Not Updated... Plese Try Again";
    }
                    ...
                    <div class="panel panel-bd lobidrag">
                        ...
                        <div class="panel-body">
                            ...
                            <form class="col-md-12" action="" method="post" enctype="multipart/form-data">
                                ...
                                <?php
                                $sqlqry= mysqli_query($con,"select * from  logo where id=1 ");
                                ...
                                <!-- <div class="col-md-12">
                                 ...
                                 <div class="col-md-12">
                                      ...
                                      <img src="../logo/<?php echo $tota['image']?>" style="height: 150px;">      
                                            <label> Choose The Logo :</label>
                                ...
                                <!-- <div class="col-md-12">
                                    <div class="col-md-12">
                                        <div class="form-group col-sm-12">
                                            ...
                                            <textarea name="editor5" ><?php echo $tota['content'] ?></textarea>
                                        </div>
                                    </div>
                                </div> -->
                                ...
                                <div class="col-md-12">
                                    <div class="reset-button" style="padding-left: 390px;">
                                        <input type="submit" name="submit" value="Update Logo" class="btn btn-add">
                                    </div>
                                </div>
