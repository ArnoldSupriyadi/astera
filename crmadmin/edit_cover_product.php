...
if(isset($_POST['submit'])){
    ...
    $sql = mysqli_query($con, "UPDATE product_banner_image SET banner_image='$file_name'  WHERE id=$pid ");
            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="panel panel-bd lobidrag">
                        ...
                        <?php
                            $crid=$_GET['crtid'];
                            $sql= mysqli_query($con,"select * from product_banner_image where id='$crid'  ");
...
<div class="col-md-12">
    <div class="reset-button" style="padding-left: 390px;">
        <input type="submit" name="submit" value="Update Cover Product" class="btn btn-add">
    </div>
</div>
